...
fun LazyListScope.inlineTip(modifier: Modifier = Modifier, tip: Tip) {
...
fun InlineTip(
    ...
    AnimatedContent(targetState = show, transitionSpec = { enter with exit }, label = "show/hide inline tip") {
        if (it) {
