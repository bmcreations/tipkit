 ...
 */
internal fun getCoordinatesForPlacement(
        ...
        Alignment.TopCenter -> {
            ...
            when {
                isYLessThanZero && isAnchorCovered -> {
                    ...
                    val y = anchorPosition.y.roundToInt() - anchorSize.height - padding.roundToInt()
                    x to y
                }
            }
        }
        ...
        Alignment.CenterStart -> {
            ...
            when {
                ...
                isBeyondHeightBounds -> {
                    ...
                    val x = anchorPosition.x.roundToInt() - tip.width - padding.roundToInt()
        ...
        Alignment.CenterEnd -> {
            ...
            when {
                isBeyondWidthBounds -> {
                    ...
                    val x = anchorPosition.x.roundToInt() + anchorSize.width + padding.roundToInt()
                    val y = anchorPosition.y.roundToInt() + anchorSize.height / 2 - tip.height / 2
                    x to y
                }
            }
